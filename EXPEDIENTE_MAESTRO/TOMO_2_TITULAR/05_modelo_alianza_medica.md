# MODELO DE ALIANZA MÉDICA: CAPTAR LA DEMANDA SIN EJECUTAR EL ACTO MÉDICO

**Confidencial. Uso de la titular.**

## 1. EL PROBLEMA COMERCIAL, PLANTEADO CORRECTAMENTE
...
**A. Derivación pura (exposición mínima).** Mirë deriva al consultorio del médico; el paciente regresa para el cuidado no invasivo. Sin insumos médicos en el local, sin espacio compartido. Ingreso: preparación y cuidado posterior. **Es el esquema recomendado para iniciar.**

**B. Médico con agenda en el espacio (exposición media, mayor ingreso).** El médico atiende ciertos días en un espacio delimitado, con su propia responsabilidad, sus insumos y su expediente, bajo contrato de uso de espacio. Requiere revisar previamente con abogado sanitario si esa actividad, en el domicilio y con esa frecuencia, exige aviso o licencia sanitaria propia para el consultorio; **no debe iniciarse sin ese dictamen**, porque la actividad médica en el inmueble puede requerir su propio trámite y responsable sanitario.

**C. Unidad con servicios de atención médica (mayor inversión).** Migrar a persona moral, obtener el aviso o licencia correspondiente, designar responsable sanitario con cédula, cumplir NOM-016-SSA3-2012, expediente clínico y manejo de RPBI. Aquí el establecimiento sí aloja el servicio médico, pero **quien lo ejecuta sigue siendo el médico**: la cosmiatra nunca inyecta, en ningún escenario.

## 5. PERFIL DEL MÉDICO Y VERIFICACIÓN OBLIGATORIA

Antes de firmar cualquier convenio, se verifica y se archiva copia de:

☐ Título profesional y **cédula profesional** (validada en el Registro Nacional de Profesionistas)
☐ Cédula de especialidad, cuando la ofrezca
☐ Identificación oficial
☐ **Póliza de responsabilidad civil profesional vigente** (si no la tiene, no se firma)
☐ Datos fiscales para facturación independiente
☐ Aviso o licencia sanitaria de su propio consultorio, cuando aplique

Bandera roja: el médico que propone que "el personal aplique y él supervise a distancia", o que ofrece dejar producto en el local. Esa propuesta trasladaría toda la responsabilidad penal a la titular. Se rechaza y se documenta el rechazo.

## 6. GUION COMERCIAL PARA NO PERDER A LA CLIENTA
...
☐ Esquema A ☐ Esquema B (previo dictamen de abogado sanitario) ☐ Esquema C (proyecto)

Médico(s) considerados: ________________________________________________________

Fecha: ____/____/20____ Firma de la titular: __________________________

*No constituye asesoría legal individualizada. Los esquemas B y C requieren dictamen previo de abogado sanitario y validación ante COFEPRIS y la Alcaldía.*
